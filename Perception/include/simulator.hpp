...
public:
    ...
    std::vector<std::vector<double>> get_observation_points(
    ...
    std::vector<std::vector<double>> ray_casting_filter(std::vector<double> theta_l, 
                    std::vector<double> range_l, double angle_resolution);
};
...
std::vector<std::vector<double>> LidarSimulator::ray_casting_filter(
    std::vector<double> theta_l, std::vector<double> range_l, double angle_resolution)
{
    std::vector<std::vector<double>> rxy(2);
    std::vector<double> range_db(
